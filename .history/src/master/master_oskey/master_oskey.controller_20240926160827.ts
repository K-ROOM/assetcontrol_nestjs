...
export class MasterOskeyController {
  ...
  @Get('/:osLicenseType')
  findWithBrandAndSubCategory(@Param('osLicenseType') osLicenseType: string, @Param('subCategory') subCategory: string) {
    return this.masterModelService.findWithBrandAndSubCategory(brand, subCategory);
  }
