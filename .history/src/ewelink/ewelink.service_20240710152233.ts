...
export class EwelinkService {
  ...
  private readonly devicesUrl: string = 'https://api.ewelink.cc/v2/devices';
  ...
  async getData(): Promise<any> {
    ...
    const appSecret = this.configService.get<string>('9VMqg1jSQXB1sQOiKWPr2zOrNlhjJRny');
  ...
  async getDevices(): Promise<any> {
    ...
    const response = await this.httpService.get(this.devicesUrl, {
      headers: {
