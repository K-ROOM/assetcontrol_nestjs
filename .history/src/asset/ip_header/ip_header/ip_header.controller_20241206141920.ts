...
export class IpHeaderController {
  ...
  update(@Param('ip1') ip1: number, @Param('ip2') ip2: number, @Param('ip3') ip3: number, @Param('ip4') ip4: number, @Param('edp_No') edp_No: string, @Param('oip1') oip1: number, @Param('oip2') oip2: number, @Param('ip3') ip3: number, @Param('ip4') ip4: number) {
