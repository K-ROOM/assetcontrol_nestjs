...
export class IpHeaderController {
  ...
  @Patch('/:ip1/:ip2/:ip3/:ip4')
  update(@Param('ip1') ip1: number, @Param('ip2') ip2: number, @Param('ip3') ip3: number, @Param('ip4') ip4: number, @Body() updateIpHeaderDto: UpdateIpHeaderDto) {
    console.log('test')
    return this.ipHeaderService.update(ip1, ip2, ip3, ip4, updateIpHeaderDto);
  }
  ...
  @Get('/:edp_No')
  findIPByEdpNo(@Param('edp_No') edp_No: number) {
    return this.ipHeaderService.findIPByEdpNo(ip1, ip2, ip3, ip4);
  }
