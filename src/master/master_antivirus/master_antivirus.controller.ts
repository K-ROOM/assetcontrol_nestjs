...
export class MasterAntivirusController {
  ...
  @Get('/count')
  findAllCount() {
    return this.masterAntivirusService.findAllCount();
  }

  @Get(':antivirusVersion')
  findOne(@Param('antivirusVersion') antivirusVersion: string) {
    return this.masterAntivirusService.findOne(antivirusVersion);
  }
